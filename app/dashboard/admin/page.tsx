...
function AdminDashboardContent() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const kpiResponse = await authenticatedFetch(API_ENDPOINTS.dashboard.admin.kpis());
      if (kpiResponse.ok) {
      ...
      // 加载风险告警
      const riskResponse = await authenticatedFetch(API_ENDPOINTS.dashboard.admin.risks());
      if (riskResponse.ok) {
      ...
      // 加载最近活动
      const activityResponse = await authenticatedFetch(API_ENDPOINTS.dashboard.admin.activities());
